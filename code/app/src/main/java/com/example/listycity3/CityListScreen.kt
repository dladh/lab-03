...
fun CityListScreen(
    ...
    var selectedCity by remember { mutableStateOf<City?>(null) } //? -> either city or null
    var updatedCityName by remember {mutableStateOf("")}   //3.variables for editing city and province name
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        //UPDATING THE CITY AND THE PROVINCE
        if (selectedCity != null) {
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { updatedCityName = it }, //city
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Update Province") },    //province
                    modifier = Modifier.weight(1f)
                )
...
fun CityListScreenPreview() {
    ListyCity3Theme {
        CityListScreen(
            ...
            onAddCity = {},
            onUpdateCity = {_, _ -> } //ignoring both city objs
        )
    }
}
